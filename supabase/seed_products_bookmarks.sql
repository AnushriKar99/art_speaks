...
items (slug, name, price_cents, stock_count) as (
  values
    ('heart-bow-pin',              'Heart Bow Pin',               5000::int,  2::int),
    ('bow-pin-1',                  'Bow Pin (1)',                 5000,       2),
    ('bow-pin-2',                  'Bow Pin (2)',                 5000,       2),
    ('strawberry-pin',             'Strawberry Pin',              7000,       6),
    ('frog-pin',                   'Frog Pin',                    7000,       2),
    ...
    ('starry-night',               'Starry Night',               12000,       3),
    ('winter',                     'Winter',                     12000,       1),
    ('wheat-field-with-cypresses', 'Wheat Field with Cypresses', 12000,       1)
)
...
select
  i.slug, i.name, c.description, c.artisan_note, i.price_cents, 'INR',
...
-- Check what landed:
--   select slug, name, price_cents/100.0 as rupees, stock_count
